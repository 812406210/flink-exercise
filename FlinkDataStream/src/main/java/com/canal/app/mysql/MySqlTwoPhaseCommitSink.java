...
import com.canal.app.utils.MysqlConnectUtil;
...
public class MySqlTwoPhaseCommitSink extends TwoPhaseCommitSinkFunction<Tuple2<String,Integer>,Connection,Void> {
    ...
    protected Connection beginTransaction() throws Exception {
        ...
        String url = "jdbc:mysql://hadoop101:3306/test?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull&useSSL=false&autoReconnect=true";
        Connection connection = MysqlConnectUtil.getConnection(url, "root", "yang156122");
        return connection;
    }
    ...
    protected void commit(Connection connection) {
        ...
        MysqlConnectUtil.commit(connection);
    }
    ...
    protected void abort(Connection connection) {
        ...
        MysqlConnectUtil.rollback(connection);
    }
}
