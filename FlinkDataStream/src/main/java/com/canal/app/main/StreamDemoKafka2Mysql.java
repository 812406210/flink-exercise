...
import com.canal.app.mysql.MySqlTwoPhaseCommitSink;
...
public class StreamDemoKafka2Mysql {
    //topic
    private static final String topic_ExactlyOnce = "two-phase";
...
//
//        kafkaConsumer011.setStartFromSpecificOffsets(specificStartOffsets);
