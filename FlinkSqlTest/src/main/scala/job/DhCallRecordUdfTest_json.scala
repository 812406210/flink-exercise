 ...
 */
object DhCallRecordUdfTest_json {
...
//    val path = parameters.get("config_path")
    val parameterTool: ParameterTool = ParameterTool.fromPropertiesFile(getClass.getResourceAsStream("/test.properties"))
    ...
    env.setStateBackend(new FsStateBackend("file:///data/soft/flink-1.11.3/flink-1.11.3/checkpoint/DhCallRecordUdfTest"))
