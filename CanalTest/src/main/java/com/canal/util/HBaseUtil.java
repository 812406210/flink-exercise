...
public class HBaseUtil {
    ...
    static{
        ...
        conf.set("hbase.rootdir","hdfs://uat-datacenter1:9000/hbase");
        //使用eclipse时必须添加这个，否则无法定位
        conf.set("hbase.zookeeper.quorum","uat-datacenter1");
    ...
    public static void deleteByKey(String tableNameString, String rowKey) throws IOException {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(getdata("demo","1","info","avg"));
    }
